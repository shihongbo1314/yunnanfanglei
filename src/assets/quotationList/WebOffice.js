...
function ShowPage(id,fileName,role,regionId,sessionID,projectId,ishowAlgin,company) {
	...
	var path = `aviation/authorizedTwo?id=${id}&fileName=${fileName}&role=${role}&regionId=${regionId}&sessionID=${sessionID}&projectId=${projectId}&ishowAlgin=${ishowAlgin}&company=${company}`;
	var strUrl;
