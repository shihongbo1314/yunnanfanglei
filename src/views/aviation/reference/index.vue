<template>
    <div class="reference">
        <div class="All" v-if="!addishow">
            <div class="addNewYewu" v-if="sessionName == '备案人'">
                <span @click="addClick"><i class="el-icon-plus"
                        style="font-weight:900;margin-right:10px;" />新增备案信息</span>
            </div>
            <div class="condition">
                <el-form :inline="true" :model="formInline" size='mini' class="demo-form-inline">
                    <el-form-item label="报告档案编号：">
                        <el-input v-model="formInline.number" placeholder="请填写档案编号" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="行政区划：">
                        <el-input v-model="formInline.regionName" placeholder="请填写行政区划" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="委托方名称：">
                        <el-input v-model="formInline.company_name" placeholder="请填写委托方名称" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="项目名称：">
                        <el-input v-model="formInline.project_name" placeholder="请填写项目名称" clearable></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="检测单位：">
                        <el-input v-model="formInline.textCompany" placeholder="请填写检测单位" clearable></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="到账时间：">
                        <el-date-picker v-model="formInline.timeDateArrival" type="daterange" range-separator="至"
                            start-placeholder="开始日期" end-placeholder="结束日期" format="yyyy-MM-dd"
                            value-format="yyyy-MM-dd">
                        </el-date-picker>
                    </el-form-item>
                    <el-form-item label="真实姓名：">
                        <el-input v-model="formInline.trueName" clearable placeholder="请填写真实姓名"></el-input>
                    </el-form-item>
                    <el-form-item label="合同编号：">
                        <el-input v-model="formInline.contractNumber" clearable placeholder="请填写合同编号"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item>
                        <el-date-picker v-model="formInline.SaveTime" type="daterange" range-separator="至"
                            start-placeholder="出具报告开始时间" end-placeholder="出具报告结束时间" format="yyyy-MM-dd"
                            value-format="yyyy-MM-dd">
                        </el-date-picker>
                    </el-form-item>
                    <el-form-item label="检测类别：" v-if="sessionName == '备案人' || sessionName == '管理员'">
                    ...
                    <el-form-item label="人员归属">
                        <!-- <el-select v-model="formInline.company" placeholder="请选择" clearable>
                            <el-option label="云南省气象灾害防御技术中心" value="1"></el-option>
                            <el-option label="云南启旭科技有限公司" value="2"></el-option>
                        </el-select> -->
            ...
            <div class="footer-table" :class="sessionName == '备案人' ? 'all' : 'dan'">
                <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" border style="width: 100%;"
                    class="classsty" height="calc(100% - 85px)">
                    <el-table-column type="expand" label="详细信息" width="80">
                        <template slot-scope="props">
                            ...
                            <el-form label-position="left" inline class="demo-table-expand hides"
                                v-if="props.row.multiplex != '4' && props.row.multiplex != '5'">
                    ...
                    <el-table-column label="报告档案编号" align="center">
                        <template slot-scope="scope">{{ scope.row.number }}</template>
                    </el-table-column>

                    <el-table-column prop="monthCount" label="月编号" align="center">
                    </el-table-column>
                    ...
                    <el-table-column prop="projectName" label="检测报告" align="center">
                        <template slot-scope="scope">
                    ...
                    <el-table-column prop="roleName" label="当前节点" align="center">
                    </el-table-column>
                    ...
                    <el-table-column label="项目状态" align="center">
                        <template slot-scope="scope">
                            <el-tag :type="scope.row.state | stateFilter(scope.row.state)"
                                ...
                                <span
                                    v-if="['32', '33', '26', '27', '28', '29', '31', '35'].includes(scope.row.state)">{{
                                        scope.row.state | statusFilterNew }}</span>
                                <span v-else>{{ scope.row.state | statusFilter(scope.row.examineTaskMap != null ?
                                    scope.row.examineTaskMap.role_id : "") }}</span>
                            </el-tag>
                            <div v-if="scope.row.state == '16'">{{ scope.row.examineTime }}</div>
                        </template>
                    </el-table-column>
                    <el-table-column label="父项目信息" align="center">
                        <template slot-scope="scope">
                            <span style="cursor: pointer;" @click="parentClick(scope.row.parentMap)">{{
                                scope.row.parentMap
                                    != null ?
                                    scope.row.parentMap.number : '-' }}</span>
                            <el-button type="text" v-if="scope.row.parentMap != null"
                                @click="parentClick2(scope.row.parentMap)">点击跳转</el-button>
                        </template>
                    </el-table-column>
                    <el-table-column prop="handle" label="操作" align="center" width="180"
                        v-if="sessionName != '对接人' && sessionName != '审核人'">
                        <template slot-scope="scope">
                            <span class="edit" @click="edit(scope.row, scope.row.testImg)"
                                v-if="sessionName == '编制人' && scope.row.state == '4' && isshow == false">编制 |</span>
                            <span class="submit" @click="duijie(scope.row.id)"
                                ...
                                提交 |</span>
                            <span class="audit"
                                v-if="sessionName == '备案人' && tiaojianxiugai(scope.row.state) || sessionName == '管理员' && tiaojianxiugai(scope.row.state) || sessionName == '编制人' || (sessionName == '备案审核员' && sessionNamelevel == '1')"
                                @click="updateProject(scope.row)">修改 |</span>

                            <span class="delete"
                                v-if="(setbeian(sessionName, sessionNamelevel, scope.row.state)) || (sessionName == '管理员' && sessionNamelevel == '1') || (sessionName == '备案审核员' && sessionNamelevel == '1')"
                                @click="removeProject(scope.row.id)"> 删除 |</span>
                            <span class="submit"
                                v-if="(sessionName == '备案人' || sessionName == '备案审核员') && sessionNamelevel == '1' && scope.row.multiplex != '4' && scope.row.multiplex != '5'"
                                @click="entryProjectinfo(scope.row)"> 财务信息录入</span>
                            <span class="submit"
                                v-if="sessionName == '备案人' && sessionNamelevel != '1' && tiaojian(scope.row.state) && newtiaojian(scope.row) && newnewtiaojian(scope.row.multiplex)"
                                @click="applyFor(scope.row)"> 申请开票 |</span>
                            <span class="audit"
                                v-if="sessionName == '备案人' && sessionNamelevel != '1' && newnewtiaojian(scope.row.multiplex) && scope.row.state == '16'"
                                @click="CheckApply(scope.row)"> 到账查询申请</span>
                            <span class="audit"
                                v-if="(sessionName == '备案人' && scope.row.state == '16' && scope.row.regionMap.level == sessionNamelevel && newnewtiaojian(scope.row.multiplex))"
                                @click="reuseProject(scope.row)"> 复用</span>
                            <span class="edit" v-if="sessionName == '备案人' && scope.row.state == '35'"
                                @click="SubmitAuditor(scope.row)">|提交审核员</span>
                            <div>
                                <span class="audit"
                                    v-if="(sessionName == '编制人' && scope.row.state == '16' && scope.row.multiplex != '4' && scope.row.multiplex != '5')"
                                    @click="ChildReport(scope.row)">子报告</span>
                            </div>
        ...
        <Addnew v-if="addishow" @goback="goback($event)" />
        ...
        <el-dialog title="选择审核人" :visible.sync="SubmitAuditorFlag" width="20%">
            <el-select style="width:100%" v-model="applyForinfoFrom.auditor" clearable placeholder="选择审核人">
                <el-option v-for="item in applyForinfoFromauditorList" :key="item.id" :label="item.userName"
                    :value="item.id">
                </el-option>
            </el-select>
            <span slot="footer" class="dialog-footer">
                <el-button @click="SubmitAuditorFlag = false">取 消</el-button>
                <el-button type="primary" @click="SubmitAuditorQueding">确 定</el-button>
            </span>
        </el-dialog>
        ...
        <el-dialog title="修改信息" :visible.sync="editDilong" v-loading="loading" @close='close' top="5vh" width="1080px">
            <div class="editCont">
                <el-form label-position="right" label-width="100px">
                    <div class="cont_c_o">
                            ...
                            <div style="width: 50%;">
                                <p v-if="sessionName != '备案人'">
                                    <el-form-item label="报告档案编号：" class="item">
                                        ...
                                        <span style="color:red">第<el-input v-model="formInline.Number"
                                                :disabled="State35 && StateNull" @input="handleInput"
                                                style="width:145px;"></el-input>号 <el-input v-model="formInline.Number2"
                                ...
                                <p v-else>
                                    <el-form-item label="类别：">
                                        <el-select style="width:100%" v-model="enquire.category" placeholder="请选择">
                                            <el-option label="验收检测" value="验收检测"></el-option>
                                            <el-option label="定期检测" value="定期检测"></el-option>
                                        </el-select>
                                    </el-form-item>
                        ...
                        <div style="width: 100%;display: flex">
                            <div style="width: 50%" v-if="sessionName == '编制人' || sessionName == '备案人'">
                                <p>
                                    <el-form-item label="合同时间：">
                                        <el-date-picker v-model="enquire.contractTime" type="date" placeholder="选择日期"
                        ...
                        <div style="width: 100%;display: flex;">
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="委托方名称：">
                                        <el-input placeholder="请输入内容" :disabled="State35" v-model="enquire.companyName">
                                        </el-input>
                                    </el-form-item>
                                </p>
                            </div>
                            <div style="width: 50%" v-if="sessionName == '备案人' && sessionNamelevel == '1'">
                                <p>
                                    <el-form-item label="存档日期：">
                                        <el-date-picker v-model="enquire.filingTime" type="date" placeholder="选择日期"
                                            value-format="yyyy-MM-dd" style="width:100%">
                                        </el-date-picker>
                                    </el-form-item>
                                </p>
                            ...
                            <div style="width: 50%" v-else>
                                <p>
                                    <el-form-item label="人员归属：">
                                        <!-- <el-select v-model="enquire.company" placeholder="请选择" clearable style="width:100%">
                                            <el-option label="云南省气象灾害防御技术中心" value="1"></el-option>
                                            <el-option label="云南启旭科技有限公司" value="2"></el-option>
                                        </el-select> -->
                                        <el-input v-model="formInline.company" disabled></el-input>
                        ...
                        <div style="width: 100%;display: flex;">
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="合同金额：">
                                        <el-input placeholder="请输入内容" :disabled="State35"
                            ...
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="支付金额：">
                                        <el-input placeholder="请输入内容" :disabled="State35" v-model="enquire.payMoney">
                                        </el-input>
                                    </el-form-item>
                                </p>
                            </div>
                        ...
                        <div style="width: 100%;display: flex;" v-if="sessionName == '编制人' || sessionNamelevel == '1'">
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="检测组长电话：" class="item">
                                        <el-input v-model="enquire.liableUserPhone" placeholder="请输入内容"></el-input>
                                    </el-form-item>
                                </p>
                            </div>
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="检测日期：">
                                        <el-date-picker v-model="enquire.testTime" type="date" placeholder="选择日期"
                                            value-format="yyyy-MM-dd" style="width:100%">
                                        </el-date-picker>
                                    </el-form-item>
                                </p>
                        ...
                        <div style="width: 100%;display: flex;">
                                ...
                                <p>
                                    <el-form-item label="合同编号：" v-if="formInline.flag">
                                        <span style="color:red">{{ enquire.company == '1' ? '云' : '启'
                                                ...
                                                placeholder="选择年">
                                            </el-date-picker>]</span><el-input :disabled="State35"
                                            v-model="formInline.contractflag" style="width:80px;"></el-input>
                                        <span style="color:red">第<el-input :disabled="State35"
                                                v-model="formInline.Numberflag" @input="handleInput"
                                    ...
                                    <el-form-item label="合同编号：" v-else>
                                        <span style="color:red">{{ enquire.company == '1' ? '云' : '启'
                                            ...
                                            v-model="formInline.contract" style="width:80px;"></el-input>
                                        <span style="color:red">第<el-input :disabled="State35"
                            ...
                            <div style="width: 50%" v-if="sessionName == '备案人' && sessionNamelevel == '1'">
                                <p>
                                    <el-form-item label="预拨金额：">
                                        <el-input v-model="Number(enquire.advanceMoney).toFixed(0)" type="number"
                                            :disabled="State35"></el-input>
                                    </el-form-item>
                                </p>
                            </div>
                        ...
                        <div style="width: 100%;display: flex;" v-if="sessionName == '编制人'">
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="甲方联系人：">
                                        <el-input placeholder="请输入内容" v-model="enquire.contactUser"></el-input>
                                    </el-form-item>
                                </p>
                            </div>
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="甲方联系电话：" class="item">
                                        <el-input placeholder="请输入内容" v-model="enquire.contactMobile">
                                        </el-input>
                                    </el-form-item>
                                </p>
                            </div>
                        </div>
                        <div style="width: 100%;display: flex;" v-if="sessionName == '备案人' && sessionNamelevel == '1'">
                            ...
                            <div style="width: 50%">
                                ...
                                <p>
                                    <el-form-item label="盖章时间：">
                                        <el-date-picker v-model="enquire.sealTime" type="date" placeholder="选择日期"
                                            value-format="yyyy-MM-dd" style="width:100%">
                                        </el-date-picker>
                                    </el-form-item>
                                </p>
                            ...
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="预拨时间：">
                                        <el-date-picker v-model="enquire.advanceTime" type="date" placeholder="选择日期"
                                            value-format="yyyy-MM-dd" style="width:100%">
                                        </el-date-picker>
                                    </el-form-item>
                                </p>
                    ...
                    <div style="width: 100%;display: flex">
                        <div style="width: 50%" v-if="sessionNamelevel == '1' || sessionNamelevel == '2'">
                            <p>
                    ...
                    <div style="width: 100%;display: flex;">
                        <div style="width: 30%" v-if="sessionName != '编制人'">
                            <el-form-item label="合同附件：">
                                <el-upload action="" ref="upload" accept=".pdf,doc,docx" :limit="10" multiple
                                    :http-request="uploadHttpRequest" :file-list="fileListHE">
                        ...
                        <div style="width: 30%" v-if="sessionName == '编制人'">
                            <el-form-item label="原始记录：">
                                <el-upload action="" ref="upload" accept=".pdf,doc" :limit="10" multiple
                                    :http-request="uploadHttpRequestyuan" :file-list="fileList">
                                    <el-button slot="trigger" size="small" type="primary" plain>原始记录扫描件</el-button>
                                </el-upload>
                            </el-form-item>
                        </div>
                        <div style="width: 30%">
                            <el-form-item label="现场照片：" v-if="sessionName == '编制人'">
                                <el-upload action="" ref="upload" accept=".jpg,.jpeg,.png" :limit="20" multiple
                                    :on-remove="handleRemove" :http-request="uploadHttpimg" :file-list="fileListPng">
                                    <el-button slot="trigger" size="small" type="primary" plain>点击上传图片</el-button>
                                </el-upload>
                            </el-form-item>
                        </div>
                        <div style="width: 30%" v-if="radio == 2 || radio == 3 || radio == 5">
                            <el-form-item label="模板上传：">
                                <el-upload action="" ref="upload" accept=".doc,.docx,.pdf" :limit="10" multiple
                                    :before-remove="beforeRemoveBan" :http-request="uploadHttpdoc"
                    ...
                    <div style="padding: 10px 20px;display: flex;width: 40%;justify-content: space-between;"
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="editDilong = false" size="small">取 消</el-button>
        ...
        <ApplyFor :dilongList1="dilongList1" :TimeLineShow1="TimeLineShow1" @TimeLineShowlose1="TimeLineShowlose1" />
        <ApplyForToo :dilongList2="dilongList2" :TimeLineShow2="TimeLineShow2" @TimeLineShowlose2="TimeLineShowlose2" />
        <el-dialog title="复用项目" :visible.sync="reuse" width="31%">
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" :loading="loadingMultiplex" @click="multiplex">确 定</el-button>
            </span>
        </el-dialog>
        <el-dialog title="子报告" :visible.sync="Childishow" width="30%">
            <el-form :model="Childishowfrom" label-width="100px">
                <el-form-item label="项目名称">
        ...
        <el-dialog title="父项目详情" :visible.sync="parentisshow" v-loading="loading" width="1080px">
            <div class="editCont">
                <el-form label-position="right" label-width="100px">
                    <div class="cont_c_o">
                        <div style="width: 100%;display: flex;">
                            <div style="width: 50%;">
                                <p>
                                    <el-form-item label="项目名称：">
                                        <el-input placeholder="请输入内容" v-model="parentfrom.project_name">
                                        </el-input>
                                    </el-form-item>
                                </p>
                            </div>
                            <div style="width: 50%;">
                                <p>
                                    <el-form-item label="档案编号：">
                                        <el-input placeholder="请输入内容" v-model="parentfrom.number">
                                        </el-input>
                                    </el-form-item>
                                </p>
                            </div>
                        ...
                        <div style="width: 100%;display: flex;">
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="委托方名称：">
                                        <el-input placeholder="请输入内容" v-model="parentfrom.company_name">
                                        </el-input>
                                    </el-form-item>
                                </p>
                            </div>
                            ...
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="合同编号：">
                                        <el-input placeholder="请输入内容" v-model="parentfrom.contract_number">
                                        </el-input>
                                    </el-form-item>
                                </p>
                            </div>
                        ...
                        <div style="width: 100%;display: flex;">
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="合同金额：">
                                        <el-input placeholder="请输入内容" v-model="parentfrom.contract_money">
                                        </el-input>
                                    </el-form-item>
                                </p>
                            </div>
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="支付金额：">
                                        <el-input placeholder="请输入内容" v-model="parentfrom.pay_money">
                                        </el-input>
                                    </el-form-item>
                                </p>
                            </div>
                        ...
                        <div style="width: 100%;display: flex;">
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="类别：">
                                        <el-select style="width:100%" v-model="parentfrom.type" placeholder="请选择">
                                            <el-option label="民用" value="民用"></el-option>
                                            <el-option label="危化" value="危化"></el-option>
                                        </el-select>
                                    </el-form-item>
                            ...
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="检测单位：">
                                        <el-input placeholder="请输入内容" v-model="parentfrom.text_company">
                                        </el-input>
                                    </el-form-item>
                                </p>
                            </div>
                            ...
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="负责人电话：">
                                        <el-input v-model="parentfrom.liable_user_phone" placeholder="请输入内容"></el-input>
                                    </el-form-item>
                                </p>
                            </div>
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="检测日期：">
                                        <el-date-picker v-model="parentfrom.test_time" type="date" placeholder="选择日期"
                                            value-format="yyyy-MM-dd" style="width:100%">
                                        </el-date-picker>
                                    </el-form-item>
                                </p>
        ...
        <el-dialog title="财务信息录入" :visible.sync="Projectinfo" width="1080px" custom-class='My_el-dialog'>
            <el-tabs v-model="activeNamePinzheng" type="card" @tab-click="getexamineSelectPinzheng">
                <el-tab-pane label="财务信息列表" name="first">
                    <el-button type="success" icon="el-icon-plus" size="mini" style="margin:10px 0" @click="AddClick()"
                        v-if="sessionName == '备案人' && sessionNamelevel == '1'">新
                        增</el-button>
                        ...
                        <el-table-column label="状态" align="center">
                            <template slot-scope="scope">
                                <el-tag :type="scope.row.state | stateFilter(scope.row.state)" style="cursor: pointer;"
                                    @click.stop="invoiceexaminelistzuofei(scope.row)">{{ scope.row.state |
                                        applyForinfoFilterzuofei }}</el-tag>

                            </template>
                        </el-table-column>
                        <el-table-column label="操作" align="center" width="150">
                            <template slot-scope="scope" v-if="sessionName == '备案人' && sessionNamelevel == '1'">
                                <div style="display:flex;justify-content: space-around">
                                    <el-button size="mini" v-if="scope.row.state != '4'"
                                        @click="handleEdit(scope.row)">修改</el-button>
                                    <el-button type="danger" size="mini" @click="removeClick(scope.row)">删 除</el-button>
                                </div>
                ...
                <el-tab-pane label="到账申请菜单" name="second">
                    <el-table :data="financialInfoPinzheng" style="width: 100%" border>
                        <el-table-column label="合同档案号" align="center">
                            <template slot-scope="scope">
                                <span>{{ scope.row.projectMap.contractNumber }}</span>
                            </template>
                        </el-table-column>
                        <el-table-column label="项目名称" align="center">
                            <template slot-scope="scope">
                                <span>{{ scope.row.projectMap.projectName }}</span>
                            </template>
                        </el-table-column>
                        <el-table-column label="委托方名称" align="center">
                            <template slot-scope="scope">
                                <span>{{ scope.row.projectMap.companyName }}</span>
                            </template>
                        </el-table-column>
                        <el-table-column label="到账金额" align="center">
                            <template slot-scope="scope">
                                <span>{{ scope.row.receivedMoney }}</span>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="状态" align="center">
                            <template slot-scope="scope">
                                <el-tag :type="scope.row.state | stateFilter(scope.row.state)"
                                    style="cursor: pointer;">{{ scope.row.state |
                                        stateFilterPinzheng
                                    }}</el-tag><!-- @click.stop="invoiceexaminelistPinzheng(scope.row)" -->
        ...
        <el-dialog title="开票信息" :visible.sync="applyForinfo" width="1080px" custom-class='My_el-dialog'>
            <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                <el-tab-pane label="开票申请" name="first"> <el-button type="success" icon="el-icon-plus" size="mini"
                        style="margin:10px 0" @click="AddapplyForClick()">申 请</el-button>
                    <el-table :data="applyForInfoList" style="width: 100%" border>
                        <el-table-column prop="party" label="开票方名称" align="center">
                        </el-table-column>
                        <el-table-column prop="dutyNumber" label="纳税人识别号" align="center">
                        </el-table-column>
                        <el-table-column prop="applicationAmount" label="开票金额" align="center">
                        </el-table-column>
                        <el-table-column prop="type" label="发票类型" align="center">
                        </el-table-column>
                        <el-table-column prop="reamark" label="备注信息" align="center">
                        </el-table-column>
                        <el-table-column label="状态" align="center">
                            <template slot-scope="scope">
                                <el-tag :type="scope.row.state | stateFilter(scope.row.state)" style="cursor: pointer;"
                                    @click.stop="invoiceexaminelist(scope.row)">{{ scope.row.state |
                                        applyForinfoFilter }}</el-tag>
                        ...
                        <el-table-column label="操作" align="center" width="150">
                            <template slot-scope="scope">
                                <div style="display:flex;justify-content: space-around">
                                    <el-button size="mini" v-if="scope.row.state != '4'"
                                        @click="handleEditapplyForinfo(scope.row)">修改</el-button>
                                    <el-button type="danger" size="mini" v-if="scope.row.state != '4'"
                                        @click="removeClickapplyForinfo(scope.row)">删 除</el-button>
                                </div>
                ...
                <el-tab-pane label="开票记录" name="second"><!-- <el-button
                        type="success"
                        icon="el-icon-plus"
                        size="mini"
                        style="margin:10px 0"
                        ...
                        <el-table-column label="操作" align="center" width="150">
                            <template slot-scope="scope">
                                <div style="display:flex;justify-content: space-around">
                                    ...
                                    >再次提交</el-button> -->
                                    <el-button type="danger" size="mini" v-if="scope.row.state == null"
                                        @click="abolishClick(scope.row)">申请废除</el-button>
                                </div>
        ...
        <el-dialog :title="titleInfo" :visible.sync="newProjectinfo" width="1080px">
            <div class="editCont">
                <el-form label-position="right" label-width="100px">
                    <div class="cont_c_o">
                        <div style="width: 100%;display: flex;" v-if="sessionName == '备案人' && sessionNamelevel == '1'">
                            ...
                            <div style="width: 50%">
                                <p>
                                    <el-form-item label="入账金额：">
                                        <el-input v-model="invoiceinfo.arrivalMoney" type="number"></el-input>
                                    </el-form-item>
                                </p>
                            </div>
                        </div>
                        ...
                        <div style="width: 100%;display: flex;" v-if="sessionName == '备案人' && sessionNamelevel == '1'">
                            ...
                            <div style="width: 50%" v-if="sessionName == '备案人' && sessionNamelevel == '1'">
                                <p>
                                    <el-form-item label="开票日期：">
                                        <el-date-picker v-model="invoiceinfo.invoiceTime" type="date" placeholder="选择日期"
                                            value-format="yyyy-MM-dd" style="width:100%">
                                        </el-date-picker>
                                    </el-form-item>
                                </p>
                            ...
                            <div style="width: 50%" v-if="sessionName == '备案人' && sessionNamelevel == '1'">
                                ...
                                <p>
                                    <el-form-item label="入账时间：">
                                        <el-date-picker v-model="invoiceinfo.arrivalTime" type="date" placeholder="选择日期"
                                            value-format="yyyy-MM-dd" style="width:100%">
                                        </el-date-picker>
                                    </el-form-item>
                                </p>
                        ...
                        <div style="width: 100%;display: flex" v-if="sessionName == '备案人' && sessionNamelevel == '1'">
                                ...
                                <p>
                                    <el-form-item label="开票类型：">
                                        <el-select v-model="invoiceinfo.billingType" placeholder="请选择"
                                            ...
                                            <el-option v-for="(item, index) in kaiType" :key="index" :label="item"
                                                :value="item">
                                            </el-option>
                                        </el-select>
                                    </el-form-item>
                            ...
                            <div style="width: 50%">
                                <div>
                                    <p>
                                        <el-form-item label="开票金额：">
                                            <el-input v-model="invoiceinfo.invoiceMoney" type="number"></el-input>
                                        </el-form-item>
                                    </p>
            ...
            <span slot="footer" class="dialog-footer">
                <el-button size="small" @click="newProjectinfo = false">取 消</el-button>
                <el-button type="primary" size="small" @click="ProjectinfoClick()">确 认</el-button>
            </span>
        </el-dialog>
        <el-dialog :title="titleApplyForInfo" :visible.sync="newApplyForinfo" width="750px">
            <div class="editCont">
                <table style="width:100%">
                    ...
                    <tr class="hang1" v-if="titleApplyForInfo == '申请开票'">
        ...
        <el-dialog :title="feichutitleApplyForInfo" :visible.sync="feichuApplyForInfo" width="750px">
            <div class="editCont">
                <table style="width:100%">
                    ...
                    <tr class="hang" v-if="!applyForinfoFrom.flag">
                        <th class="trrr">
                            <el-button type="success" size="medium" @click="feichuProjectinfoClick()">保存</el-button>
                            <el-button type="info" size="medium" @click="feichuApplyForInfo = false">返回</el-button>
                        </th>
                    </tr>
                </table>
            </div>
        ...
        <el-dialog title="到账查询申请信息" :visible.sync="CheckApplyinfoBox" width="1080px" custom-class='My_el-dialog'>
            <el-button type="success" icon="el-icon-plus" size="mini" style="margin:10px 0"
                @click="AddapplyForClickDaozhang()">申 请</el-button>
            <el-table :data="financialInfoPinzheng" style="width: 100%" border>
                <el-table-column label="合同档案号" align="center">
                    <template slot-scope="scope">
                        <span>{{ scope.row.projectMap.contractNumber }}</span>
                ...
                <el-table-column label="状态" align="center">
                    <template slot-scope="scope">
                        <el-tag :type="scope.row.state | stateFilter(scope.row.state)" style="cursor: pointer;">{{
                            scope.row.state |
                            stateFilterPinzheng }}</el-tag><!-- @click.stop="invoiceexaminelistPinzheng(scope.row)" -->
            ...
            <div class="editCont">
                <table cellpadding="3" align="center" border="1" width="100%" cellspacing="0">
                    ...
                    <tr style="height:45px">
                        ...
                        <th style="padding:0 20px;"><el-input v-model="CheckApplyinfoFrom.jine" placeholder="请输入金额"
                    ...
                    <tr style="height:45px">
                        <th style="width:30%">上传到账凭证</th>
                        <th>
                            <el-upload class="upload-demo" action="" accept=".jpg,.png,.pdf"
                                :http-request="uploadHttpimgPinzheng" :before-remove="beforeRemove" multiple :limit="3"
                                :on-remove="handleRemovePinzheng"
                    ...
                    <tr style="height:45px">
                        <th style="width:30%">选择审核人</th>
                        <th style="padding:0 20px;"><el-select v-model="applyForinfoFromBeian.auditor" placeholder="请选择"
                                style="width:100%" clearable>
                                <el-option v-for="item in applyForinfoFromauditorListBeian" :key="item.id"
                                    :label="item.userName" :value="item.id">
                                </el-option>
                            </el-select></th>
                    </tr>
                    <tr style="height:45px">
                        ...
                        <th><el-input v-model="CheckApplyinfoFrom.reamark" type="textarea"></el-input></th>
                    </tr>
                </table>
                <span slot="footer" class="dialog-footer">
                    <el-button @click="CheckApplyinfo = false" size="small">取 消</el-button>
                    <el-button type="primary" @click="submitPinzheng" size="small">提 交</el-button>
                </span>
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            applyForinfoFrom: {
                ...
                auditor: null, // 审核人,
                projectId: null, // 项目id 35
                reamark: null, //备注
            },
            applyForinfoFromBeian: {
                auditor: null, // 备案人,
            },
            CheckApplyinfoBox: false,
            ...
            applyForinfoFromauditorListBeian: [],// 省级备案人列表
            ...
            financialInfo: [],
            financialInfoPinzheng: [],
            applyForInfoList: [],
            activeNamePinzheng: 'first',
            activeName: "first",
            Project_State: null,
            loadingMultiplex: false,
            SubmitAuditorFlag: false,
    ...
    computed: {
        ...
        State35() {
            const records = JSON.parse(sessionStorage.getItem("records"));
            if (
                records.roleIdMap.level == "1" &&
                records.roleIdMap.name == "备案审核员"
            ) {
                return false;
            }
            return !["35"].includes(this.Project_State);
        },
    },
    watch: {
        addishow(val) {
    ...
    methods: {
        setbeian(Name, level, state) {
            if (Name == '备案人') {
                if (level == '1') {
                    ...
                    if (['26', '27', '28', '29', '31', '32', '33', '34', '35'].includes(state)) {
                        return true;
                    } else {
                        return false;
                    }
        ...
        handleInput(val) {
            ...
            if (reg.test(val)) {
                ...
                this.formInline.Number = this.formInline.Number.slice(0, -1);
            }
        },
        open(message) {
        ...
        parentClick2(row) {
            /* row.number */
            this.getProject(1, null, row.number);
        },
        getDockUserbianzhi(regionId) {
            const params = JSON.parse(sessionStorage.getItem("records"));
            getDockUserbianzhi({
        ...
        getProject(current, projectId, row) {
            ...
            if (this.sessionName == "备案人" || this.sessionName == "管理员") {
                parameter.category = this.formInline.category;
            }
            ...
            if (this.formInline.SaveTime) {
                parameter.startPassTime = this.formInline.SaveTime[0];
                parameter.endPassTime = this.formInline.SaveTime[1];
            }
        ...
        getexamineSelectPinzheng() {
            ...
            examineSelectPinzheng({
                ...
                if (res.data.state == 200) {
                    res.data.records.map((item) => {
                        this.financialInfoPinzheng.push(item);
                    });
                } else {
                    this.financialInfoPinzheng = []
                }
        ...
        reuseProject(row) {
            ...
            /* 处理合同编号 */
            const [contract, year, Number_] =
                this.reuseform.number.split(/[\[\]]/);
            if (year && Number_) {
                this.reuseform.year = year;
                if (Number_.includes("第") && Number_.includes("号")) {
                    this.reuseform.contract = Number_.split("第")[0];
                    this.reuseform.Number =
                        Number_.split("第")[1].split("号")[0];
                }
            } else {
                this.reuseform.year = "";
                this.reuseform.contract = "";
                this.reuseform.Number = "";
            }
        },
        /* 子报告 */
        ...
        editDilongclick(re) {
            if (this.sessionName == "备案人") {
                ...
                if (this.enquire.category != null) {
                    this.formData.set("category", this.enquire.category);
                }
                ...
                if (this.enquire.company != null) {
                    this.formData.set("company", this.enquire.company);
                }
                ...
                if (
                    ["4", "5"].includes(this.Project_State) &&
                    !this.enquire.Number2
                ) {
                    this.$message.info("修改子报告时需录完整报告档案编号");
                    return;
                }
                this.loading = true;
                if (re == 1) {
                ...
                if (this.formInline.flag) {
                    this.formData.set(
                        "contractNumber",
                        `${this.enquire.company == '1' ? '云' : '启'}雷检字` + '[' + this.formInline.yearflag + ']' + this.formInline.contractflag + '第' + this.formInline.Numberflag + '号'
                    );
                } else {
                    this.formData.set(
                        "contractNumber",
        ...
        getPromotionBeian(row) {
            ...
            getDockUser(params).then((res) => {
                this.applyForinfoFromauditorListBeian = res.data.records;
            });
        },
        // 申请开票确定
        invoiceRequestsaveOrUpdate() {
        ...
        invoiceexaminelistPinzheng(row) {
            getinvoicecancel({
                type: "all",
                projectId: this.projectId.projectId,
                invoiceId: row.id,
        ...
        tiaojian(state) {
            if (
                ["3", "5", "29", "31", "32", "33", "34", "35"].includes(state)
            ) {
                return false;
            } else {
                return true;
        ...
        newtiaojian(row) {
            if (row.type == '危化' && row.category == '验收检测') {
                return false;
            } else {
                return true;
            }
        },
        newnewtiaojian(multiplex) {
            if (multiplex == '4' || multiplex == '5') {
                return false;
            } else {
                return true;
            }
        },
        tiaojianxiugai(state) {
            if (["3", "35"].includes(state)) {
                return true;
            } else {
                return false;
            }
        ...
        SubmitAuditorQueding() {
            if (this.applyForinfoFrom.auditor == null) {
                return this.$message.warning("审核人不能为空");
            } else {
                SubmitAuditorQueding({
                    reviewerId: this.applyForinfoFrom.auditor,
                    projectId: this.applyForinfoFrom.projectId,
                }).then((res) => {
                    if (res.data.state == 200) {
                        this.$message.success("提交审核员成功");
                        this.SubmitAuditorFlag = false;
                        this.applyForinfoFrom.auditor = null;
                        this.applyForinfoFrom.projectId = null;
                        this.getProject();
                    } else {
                        this.SubmitAuditorFlag = false;
                    }
        ...
        CheckApply(row) {
            ...
            this.CheckApplyinfoFrom.projectName = row.projectName;
            this.CheckApplyinfoFrom.companyName = row.companyName;
            this.CheckApplyinfoBox = true;
            this.getPromotion(row);
            this.getPromotionBeian(row);
            this.projectId.projectId = row.id;
            this.getexamineSelectPinzheng();
        },
        beforeRemove(data) {
            this.fileListPinzheng.splice(data.file, 1);
        },
        uploadHttpimgPinzheng(data) {
            ...
            if (!extension) {
                this.$message.error("到账凭证必须为png,jpg,pdf格式");
                this.fileListPinzheng = [];
            } else {
        ...
        handleRemovePinzheng(file, fileList) {
            this.formDataPinzheng = new FormData();
            this.fileListPinzheng = fileList;
            fileList.map((item) => {
                this.formDataPinzheng.append("file", item);
            });
        },
        /* 限制上传文件个数 */
        handleChange(file) {
        ...
        submitPinzheng() {
            const records = JSON.parse(sessionStorage.getItem("records"));
            if (this.CheckApplyinfoFrom.jine == '' || this.CheckApplyinfoFrom.jine == null) {
                return this.$message.info("到账金额不能为空");
            }
            if (this.CheckApplyinfoFrom.time == '' || this.CheckApplyinfoFrom.time == null) {
                return this.$message.info("到账时间不能为空");
            }
            if (this.formDataPinzheng.has("file") == false) {
                return this.$message.error("到账凭证不能为空");
            }
            if (this.applyForinfoFromBeian.auditor == null || this.applyForinfoFromBeian.auditor == "") {
                return this.$message.warning("审核人不能为空");
            }

            this.formDataPinzheng.append(
                "projectId",
                this.CheckApplyinfoFrom.id,
            );
            this.formDataPinzheng.append(
                "auditee",
                records.id
            ...
            this.formDataPinzheng.append(
                "receivedMoney",
                this.CheckApplyinfoFrom.jine,
            );
            this.formDataPinzheng.append(
                "reviewer",
                this.applyForinfoFromBeian.auditor,
            );
            this.formDataPinzheng.append(
                "receivedTime",
                this.CheckApplyinfoFrom.time,
            );
            if (this.CheckApplyinfoFrom.reamark != null) {
                this.formDataPinzheng.append(
                    "remarks",
                    this.CheckApplyinfoFrom.reamark,
                );
            }

            examineSavePinzheng(this.formDataPinzheng).then((res) => {
                if (res.data.state == 200) {
