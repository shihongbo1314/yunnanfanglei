<template>
    <div class="app-container" style="height:100%">
        ...
        <div class="content">
            <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border style="height: 100%">
                <el-table-column align="center" label="ID" prop="id" width="95">
                </el-table-column>
                <el-table-column label="真实姓名" align="left" prop="trueName">
                </el-table-column>
                <el-table-column label="职务" align="left" prop="name">
                ...
                <el-table-column align="center" prop="created_at" label="编辑" width="300">
                    <template slot-scope="scope">
                        <div style="display:flex;width:100%;justify-content: space-evenly;">
                            <div>
                                <el-button size="mini" type="success" plain @click="alter(scope.row)">修改</el-button>
                            </div>
                            <div>
                                <el-button size="mini" @click="handleEdit()">签名录入</el-button>
                            </div>
                            <div>
                                <el-upload action="" ref="upload" accept=".jpg,.jpeg,.png" :limit="10"
                                    :before-upload="uploadHttpimg" :file-list="fileList">
                                    <el-button size="mini" type="primary">上传签名</el-button>
                                </el-upload>
                            </div>
        ...
        <!-- 编辑弹框 -->
        <el-dialog title="签名模板" :visible.sync="dialog.innerVisible">

            <vue-esign ref="esign" :width="1000" :height="300" :isCrop="isCrop" :lineWidth="lineWidth"
                :lineColor="lineColor" :bgColor.sync="bgColor" class="esignature" />
            <span slot="footer" class="dialog-footer">
                <el-button @click="handleReset">清空</el-button>
                <el-button type="primary" @click="handleGenerate">上传</el-button>
            </span>

        </el-dialog>
        <!-- 修改弹框 -->
        <el-dialog title="修改个人信息" :visible.sync="reuse" width="30%">
            <el-form :model="reuseform" label-position="right" label-width="100px">
...
export default {
    ...
    methods: {
        ...
        multiplex() {
            ...
            if (regex.test(this.reuseform.password)) {
                update({
