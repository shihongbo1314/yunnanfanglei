                ...
                <el-timeline>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <div class="card_text">
                                    <span v-if="['1','3','5'].includes(item.state)"> {{ item.auditeeMap!=null ? item.auditeeMap.userName :'-' }}</span>
                                    <span v-else> {{ item.auditeeMap!=null ? item.auditeeMap.userName :'-' }} <span>{{item.roleIdInfoMap!=null ? '(' + item.roleIdInfoMap.name+')':""}}</span></span>
                                </div>
                                <div class="card_filter">
                                    ...
                                    <svg-icon
                                        icon-class="tongguo"
                                        v-if="['1','5'].includes(item.state)"
                                    />
                                    {{ item.state | applyForinfoFilterzuofei}}
...
export default {
    ...
    props: ["dilongList2", "TimeLineShow2"],
    watch: {
        TimeLineShow2(val) {
        ...
        curTimeLineShow(val) {
            if (!val) {
                this.$emit("TimeLineShowlose2", val);
            }
        },
    },
    mounted() {
