            ...
            <div>
                ...
                <el-form-item>
                    <el-button
                        type="primary"
                        size="small"
                        @click="dialog.innerVisible = true,fileListPng=[],formLabelAlign.content = null"
                    >添加</el-button>
                </el-form-item>
            </div>
        </el-form>
...
export default {
    ...
    methods: {
        ...
        handleEdit(index, row) {
            ...
            if (row.filesName != null) {
                var enclo = row.filesName.split(",");
        ...
        handleRemove(file, fileList) {
            ...
            if (fileList.length == 0) {
                this.formData.append("files", null);
            }
        },
        /* 保存 */
        preserve() {
            ...
            this.formData.append("title", this.formLabel.title);
            this.formData.append("content", this.formLabel.content);
            this.formData.append("id", this.formLabel.id);
            this.formData.append("userid", regionId.id);
