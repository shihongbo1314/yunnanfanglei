    ...
    <div class="app-container" style="height:100%">
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
            ...
            <div>
                ...
                <el-form-item>
                    <el-button type="primary" size="small" @click="onblur(1)">查询</el-button>
                </el-form-item>
                <el-form-item>
        ...
        <el-dialog width="1080px" title="添加公告信息" :visible.sync="dialog.innerVisible" append-to-body @close="closeBox">
            <el-form :label-position="labelPosition" label-width="100px" :model="formLabelAlign" ref="ruleForm">
                ...
                <el-form-item label="图片上传：">
                    <el-upload action="" ref="upload" accept=".jpg,.jpeg,.png" :http-request="uploadHttpimg"
                        :file-list="fileList">
                        <el-button slot="trigger" size="small" type="primary" plain>点击上传图片</el-button>
                    </el-upload>
                </el-form-item>
                <el-form-item style="text-align: right;">
                    <el-button size="small" @click="dialog.innerVisible = false">取消</el-button>
        ...
        <el-dialog width="1080px" title="编辑公告信息" :visible.sync="dialogone.innerVisible" append-to-body @close="closeBox">
            <el-form :label-position="labelPosition" label-width="100px" :model="formLabel" ref="ruleForm">
                ...
                <el-form-item label="图片上传：" prop="password">
                    <el-upload action="" ref="upload" accept=".jpg,.jpeg,.png" :http-request="uploadHttp"
                        :file-list="fileList">
                        <el-button slot="trigger" size="small" type="primary" plain>点击上传图片</el-button>
                    </el-upload>
                </el-form-item>
        ...
        <div v-show="imgShow" class="imgShow">
            <el-carousel :autoplay="false" height="1030px">
                <img :src="imgList"
                    style="width: 50%;left: 50%;position: relative;top: 50%;transform: translate(-50%, -50%);">
            </el-carousel>
...
export default {
    ...
    methods: {
        ...
        compile() {
            ...
            this.ftwoData.append("company", this.formInline.company);
        ...
        submitForm() {
            ...
            this.formData.append("company", this.formInline.company);
